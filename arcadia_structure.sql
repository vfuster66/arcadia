...
CREATE TABLE public.animal (
    ...
    nourriture character varying(100),
    image_id integer,
    quantite character varying(255),
    dernier_controle_veterinaire date,
    race_id integer,
    habitat_id integer
);
...
CREATE TABLE public.habitat (
    ...
    commentaire_habitat character varying(50),
    description_detaillee text NOT NULL,
    image_principale_url character varying(255),
    image_id integer
);
...
--
-- Name: habitat_images; Type: TABLE; Schema: public; Owner: arcadia_admin
--

CREATE TABLE public.habitat_images (
    habitat_id integer NOT NULL,
    image_url character varying(255) NOT NULL
);


ALTER TABLE public.habitat_images OWNER TO arcadia_admin;
...
CREATE TABLE public.rapport_veterinaire (
    ...
    "quantité" character varying(100),
    redige_par character varying(50)
);
...
--
-- Name: secondary_images; Type: TABLE; Schema: public; Owner: arcadia_admin
--

CREATE TABLE public.secondary_images (
    secondary_image_id integer NOT NULL,
    habitat_id integer,
    secondary_image_url character varying(255) NOT NULL
);


ALTER TABLE public.secondary_images OWNER TO arcadia_admin;

--
-- Name: secondary_images_id_seq; Type: SEQUENCE; Schema: public; Owner: arcadia_admin
--

CREATE SEQUENCE public.secondary_images_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.secondary_images_id_seq OWNER TO arcadia_admin;

--
-- Name: secondary_images_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: arcadia_admin
--

ALTER SEQUENCE public.secondary_images_id_seq OWNED BY public.secondary_images.secondary_image_id;


--
-- Name: service; Type: TABLE; Schema: public; Owner: arcadia_admin
--
...
ALTER TABLE public.service OWNER TO arcadia_admin;

--
-- Name: service_details; Type: TABLE; Schema: public; Owner: arcadia_admin
--
...
ALTER TABLE public.service_details OWNER TO arcadia_admin;

--
-- Name: service_details_detail_id_seq; Type: SEQUENCE; Schema: public; Owner: arcadia_admin
--

CREATE SEQUENCE public.service_details_detail_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.service_details_detail_id_seq OWNER TO arcadia_admin;

--
-- Name: service_details_detail_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: arcadia_admin
--

ALTER SEQUENCE public.service_details_detail_id_seq OWNED BY public.service_details.detail_id;
...
--
-- Name: service_service_id_seq; Type: SEQUENCE; Schema: public; Owner: arcadia_admin
--
...
ALTER TABLE public.service_service_id_seq OWNER TO arcadia_admin;

--
-- Name: service_service_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: arcadia_admin
--
...
--
-- Name: utilisateur_id_seq; Type: SEQUENCE; Schema: public; Owner: arcadia_admin
--
...
ALTER TABLE public.utilisateur_id_seq OWNER TO arcadia_admin;

--
-- Name: utilisateur_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: arcadia_admin
--
...
--
-- Name: secondary_images secondary_image_id; Type: DEFAULT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.secondary_images ALTER COLUMN secondary_image_id SET DEFAULT nextval('public.secondary_images_id_seq'::regclass);


--
-- Name: service service_id; Type: DEFAULT; Schema: public; Owner: arcadia_admin
--
...
--
-- Name: service_details detail_id; Type: DEFAULT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.service_details ALTER COLUMN detail_id SET DEFAULT nextval('public.service_details_detail_id_seq'::regclass);
...
--
-- Name: utilisateur id; Type: DEFAULT; Schema: public; Owner: arcadia_admin
--
...
--
-- Name: habitat_images habitat_images_pkey; Type: CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.habitat_images
    ADD CONSTRAINT habitat_images_pkey PRIMARY KEY (habitat_id, image_url);
...
ALTER TABLE ONLY public.possede
    ADD CONSTRAINT possede_pkey PRIMARY KEY (email, animal_id);
...
ALTER TABLE ONLY public.redige
    ADD CONSTRAINT redige_pkey PRIMARY KEY (email, rapport_veterinaire_id);
...
--
-- Name: secondary_images secondary_images_pkey; Type: CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.secondary_images
    ADD CONSTRAINT secondary_images_pkey PRIMARY KEY (secondary_image_id);


--
-- Name: service_details service_details_pkey; Type: CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.service_details
    ADD CONSTRAINT service_details_pkey PRIMARY KEY (detail_id);
...
--
-- Name: service service_pkey; Type: CONSTRAINT; Schema: public; Owner: arcadia_admin
--
...
--
-- Name: animal animal_habitat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.animal
    ADD CONSTRAINT animal_habitat_id_fkey FOREIGN KEY (habitat_id) REFERENCES public.habitat(habitat_id);
...
--
-- Name: habitat_images habitat_images_habitat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.habitat_images
    ADD CONSTRAINT habitat_images_habitat_id_fkey FOREIGN KEY (habitat_id) REFERENCES public.habitat(habitat_id);
...
--
-- Name: possede possede_animal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.possede
    ADD CONSTRAINT possede_animal_id_fkey FOREIGN KEY (animal_id) REFERENCES public.animal(animal_id);
...
--
-- Name: secondary_images secondary_images_habitat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.secondary_images
    ADD CONSTRAINT secondary_images_habitat_id_fkey FOREIGN KEY (habitat_id) REFERENCES public.habitat(habitat_id) ON DELETE CASCADE;


--
-- Name: service_details service_details_service_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: arcadia_admin
--

ALTER TABLE ONLY public.service_details
    ADD CONSTRAINT service_details_service_id_fkey FOREIGN KEY (service_id) REFERENCES public.service(service_id);
