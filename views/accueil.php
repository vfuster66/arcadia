...
?>
<link rel="stylesheet" href="/arcadia/public/css/accueil.css"> 
<!-- Style spécifique pour l'accueil -->
<div class="main-container">
    <!-- Section Hero -->
    <section id="hero">
        <div class="hero-content">
            <h1>Bienvenue au Zoo Arcadia</h1><a href="services.php" class="btn-hero">Découvrez nos services</a>
        </div>
    </section>
    ...
    <section id="habitats">
        ...
        </div><a href="habitats.php" class="learn-more-link">En savoir plus...</a>
    </section>
    ...
    <section id="animaux">
        ...
        </div><a href="animaux.php" class="learn-more-link">En savoir plus...</a>
    </section>
    ...
    <section id="services">
        ...
        </div><a href="services.php" class="learn-more-link">En savoir plus...</a>
    </section>
